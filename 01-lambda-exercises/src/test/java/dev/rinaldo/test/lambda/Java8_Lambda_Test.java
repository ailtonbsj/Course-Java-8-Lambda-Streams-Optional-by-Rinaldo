...
public class Java8_Lambda_Test extends RinaldoDevTest {
    ...
    public void test1() {
        ...
        final Thread minhaTreadLambda = new Thread(() -> soma.incrementAndGet());
    ...
    public void test2() {
        ...
        listaDeNumeros.stream().forEach(i -> System.out.print(i));
    ...
    public void test3() {
        ...
        listaDeNumeros.stream().filter(i -> i % 2 == 0).forEach(i -> System.out.print(i));
